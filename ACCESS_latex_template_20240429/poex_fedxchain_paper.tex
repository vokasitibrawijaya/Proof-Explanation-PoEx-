...
\author{\uppercase{Andri Frindito}\authorrefmark{1},
\uppercase{Mohd Haris Lye Abdullah}\authorrefmark{2},
\uppercase{Sholeh Hadi Pramono}\authorrefmark{1},
\uppercase{Mochammad Hannats Hanafi Ichsan}\authorrefmark{1},
\uppercase{Panca Mudjirahardjo}\authorrefmark{1},
\uppercase{Fauzan Arrofiqi}\authorrefmark{3},
\IEEEmembership{Member, IEEE}}

\address[1]{Department of Electrical Engineering, Universitas Brawijaya, Malang 65145, Indonesia (e-mail: andrifrnd@student.ub.ac.id, sholehpramono@ub.ac.id, mhannats@ub.ac.id, panca@ub.ac.id)}
\address[2]{Department of Computer Engineering, Universiti Teknikal Malaysia Melaka, Melaka 76100, Malaysia (e-mail: haris@utem.edu.my)}
\address[3]{Department of Computer Science, Universitas Siber Asia, Jakarta 12550, Indonesia (e-mail: fauzan@unsia.ac.id)}

\tfootnote{This work was supported by the Directorate of Research, Technology and Community Service, Ministry of Education, Culture, Research and Technology, Republic of Indonesia.}

\markboth
{Frindito \headeretal: FedXChain: Proof of Explanation Consensus for Byzantine-Robust Federated Learning}
{Frindito \headeretal: FedXChain: Proof of Explanation Consensus for Byzantine-Robust Federated Learning}

\corresp{Corresponding author: Andri Frindito (e-mail: andrifrnd@student.ub.ac.id).}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{../author_ieee/cries.png}}]{Andri Frindito}
received the B.S. degree in informatics engineering from Universitas 17 Agustus 1945 Surabaya, Indonesia, in 2008, and the M.S. degree in electrical engineering from Institut Teknologi Sepuluh Nopember, Surabaya, Indonesia, in 2014. He is currently pursuing the Ph.D. degree with the Department of Electrical Engineering, Universitas Brawijaya, Malang, Indonesia. His research interests include federated learning, blockchain technology, explainable AI, and distributed systems security.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{../author_ieee/mahdin.png}}]{Mohd Haris Lye Abdullah}
received the Ph.D. degree in computer science from Universiti Kebangsaan Malaysia in 2015. He is currently a Senior Lecturer with the Department of Computer Engineering, Universiti Teknikal Malaysia Melaka. His research interests include computer networks, network security, and distributed computing.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{../author_ieee/sholeh.png}}]{Sholeh Hadi Pramono}
received the Ph.D. degree in electrical engineering. He is currently a Professor with the Department of Electrical Engineering, Universitas Brawijaya, Malang, Indonesia. His research interests include optical communication, signal processing, and intelligent systems.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{../author_ieee/moko.png}}]{Mochammad Hannats Hanafi Ichsan}
received the Ph.D. degree in computer science. He is currently a Lecturer with the Department of Electrical Engineering, Universitas Brawijaya, Malang, Indonesia. His research interests include Internet of Things, embedded systems, and machine learning.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{../author_ieee/panca.png}}]{Panca Mudjirahardjo}
received the Ph.D. degree in electrical engineering. He is currently a Lecturer with the Department of Electrical Engineering, Universitas Brawijaya, Malang, Indonesia. His research interests include computer vision, pattern recognition, and artificial intelligence.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{../author_ieee/fauzan.png}}]{Fauzan Arrofiqi}
received the M.S. degree in computer science. He is currently a Lecturer with the Department of Computer Science, Universitas Siber Asia, Jakarta, Indonesia. His research interests include cybersecurity, blockchain technology, and network security.
\end{IEEEbiography}
